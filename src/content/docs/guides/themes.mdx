...
Each configurable section support either a single color or a list of colors that will be cycled.

#### Config type: single `color`
...
### Creating a Theme in the configuration file

Edit your config file and set any of the values in your theme:
